<?php
/**
 * CastaraTabs Package Controller File.
 *
 * @author   Christopher Ottley <cottley@gmail.com>
 * @license  See attached license file
 */
namespace Concrete\Package\CastaratabsPackage;
...
class Controller extends Package
{
     ...
     * @var string
     */
    protected $pkgHandle = 'castaratabs_package';
     ...
     * @var string
     */
    protected $pkgName = 'CastaraTabs Package';
     ...
     * @var string
     */
    protected $pkgDescription = 'Creates a tab based interface using jQueryUI';
    ...
    public function install()
    {
        ...
        $theme = BlockType::installBlockType('castaratabs', $pkg);

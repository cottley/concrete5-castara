<?php
/**
 * CastaraJS Controller File.
 *
 * @author   Christopher Ottley <cottley@gmail.com>
 * @license  See attached license file
 */
namespace Concrete\Package\CastarajsPackage\Block\Castarajs;
...
class Controller extends BlockController
{
     ...
     * @var string
     */
    protected $btDescription = 'Shared javascript libraries';

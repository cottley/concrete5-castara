<?php
/**
 * CastaraJS Package Controller File.
 *
 * @author   Christopher Ottley <cottley@gmail.com>
 * @license  See attached license file
 */
namespace Concrete\Package\CastarajsPackage;
 ...
 *
 * Shared javascript libraries for development
 *
 * @author   Christopher Ottley <cottley@gmail.com>
 * @license  See attached license file
 */
class Controller extends Package
{
     ...
     * @var string
     */
    protected $pkgHandle = 'castarajs_package';
     ...
     * @var string
     */
    protected $pkgName = 'CastaraJS Package';
     ...
     * @var string
     */
    protected $pkgDescription = 'Shared javascript libraries';
    ...
    public function install()
    {
        ...
        $theme = BlockType::installBlockType('castarajs', $pkg);

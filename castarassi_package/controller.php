<?php
/**
 * Castara Server Side Includes Package Controller File.
 *
 * @author   Christopher Ottley <cottley@gmail.com>
 * @license  See attached license file
 */
namespace Concrete\Package\CastarassiPackage;
 ...
 *
 * Server Side Software that can be dynamically linked into your application
 *
 * @author   Christopher Ottley <cottley@gmail.com>
 * @license  See attached license file
 */
class Controller extends Package
{
     ...
     * @var string
     */
    protected $pkgHandle = 'castarassi_package';
     ...
     * @var string
     */
    protected $pkgName = 'CastaraSSI Package';
     ...
     * @var string
     */
    protected $pkgDescription = 'Shared Server Side Includes that can be dynamically linked into your application';
    ...
    public function install()
    {
        ...
        $theme = BlockType::installBlockType('castarassi', $pkg);

<?php
/**
 * CastaraSSI Controller File.
 *
 * @author   Christopher Ottley <cottley@gmail.com>
 * @license  See attached license file
 */
namespace Concrete\Package\CastarassiPackage\Block\Castarassi;
...
class Controller extends BlockController
{
     ...
     * @var string
     */
    protected $btDescription = 'Server Side Software that can be dynamically linked into your application';
     ...
     * @var string
     */
    protected $btTable = 'btCastarassi';
